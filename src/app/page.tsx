...
import { Trophy, Info, PlusCircle, Zap, Star, ShieldCheck, RefreshCw } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-zinc-600 dark:text-text-dim">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-rose-500 dark:hover:text-magenta transition-colors"
            >
              pump.fun
            </a>
          </div>
