    ...
    >
      ...
      <div className="pt-3 mt-2 border-t border-line/40 flex items-center gap-2">
        ...
        <button
          ...
          className="flex-1 py-2.5 px-3 rounded-xl bg-zinc-50 dark:bg-zinc-900 dark:bg-bg-raised text-zinc-950 dark:text-white dark:text-acid border border-zinc-900 dark:border-acid/40 hover:bg-emerald-600 dark:hover:bg-acid dark:hover:text-bg font-mono text-xs font-bold uppercase tracking-wider transition-all duration-150 flex items-center justify-center gap-1.5 shadow-sm active:scale-95"
        >
